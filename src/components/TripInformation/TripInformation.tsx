...
import DriverInformationCard from "../Card/DriverInformationCard";
...
const TripBasicInformation = memo(
  ({
    item,
    displayFull = false,
    firstPosition,
...
const TripFullInformation = memo(
  ({
    item,
...
const TripTransition = memo(
  ({ firstPoint, secondPoint, duration, distance }: TripTransitionProps) => {
    return (
      <ScrollView>
        <Text>
          Đây là đường đi kết nối giữa 2 tuyến đường của bạn, từ điểm kết thúc
          của tuyến đường trước đó đến điểm bắt đầu của tuyến đường tiếp theo.
        </Text>
