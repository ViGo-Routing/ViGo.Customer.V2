...
import { Button, Input, Modal, Pressable, Select, Text, TextArea, Toast, View } from 'native-base';
import { XMarkIcon } from 'react-native-heroicons/solid';
import { createReport } from '../../service/reportService';

export function ReportModal({ bookingDetailId, isOpen, onClose }) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <Modal.Content>
                <Modal.Header>
                    <Text bold fontSize={25}>Tạo báo cáo</Text>
                    <Pressable position="absolute" top={0} right={2} onPress={onClose} mt={4} colorScheme="blue">
