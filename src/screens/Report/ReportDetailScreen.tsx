...
import { getBookingDetail } from "../../service/bookingDetailService";
  ...
  const fetchReport = async () => {
    try {
      ...
      if (reportResponse.bookingDetailId) {
        ...
        if (tripResponse.driverId) {
          const driverResponse = await getProfile(tripResponse.driverId);
