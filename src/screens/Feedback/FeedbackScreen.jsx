...
const FeedbackScreen = (
  ...
  const sendFeedback = async () => {
    ...
    await feedbackByBookingDetailId(bookingDetailId, requestData).then(
      (response) => {
        if (response !== null) {
          Toast.show({
        ...
        {bookingDetail == null ? (
          ...
          <Box>
            ...
            >
              ...
              />
              <VStack width={350}>
                <Text fontSize={20} py={3} fontWeight="medium">
                  Nhập đánh giá:
                </Text>
                <TextArea
                  h={20}
              ...
              <Button
                ...
                startIcon={
                  <Icon as={<StarIcon />} color={themeColors.linear} />
                }
              >
                Gửi đánh giá
              </Button>
