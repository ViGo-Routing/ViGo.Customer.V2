  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputDayContainer}>
              ...
              <HStack justifyContent="space-between">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Text style={styles.title}>Thời gian đón(Chiều đi)</Text>
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() => setTimeBackPickerVisible(true)}
                  >
                    <View
                      style={{
                        flexDirection: "column",
                    ...
                    >
                      <Text style={styles.title}>Thời gian đón(Chiều về)</Text>
          ...
          >
            <Box w="49%" style={[styles.cardInsideDateTime, styles.shadowProp]}>
              ...
              >
                ...
                >
                  <ClockIcon name="time-outline" size={25} color="#00A1A1" />
                </View>
        ...
        <TouchableOpacity style={styles.continueButton} onPress={submitRoute}>
